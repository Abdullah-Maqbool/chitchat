...
const ChatCardDesktop = (props) => {
  return (
    <div
      className={
        "flex flex-row items-center justify-between rounded-3xl py-4 px-4 cursor-pointer border-transparent border-2 border-solid hover:border-white" +
        (props.data.username === props.chat ? " bg-[#2e333d]" : "")
      }
      onClick={() => {
...
export default ChatCardDesktop;
